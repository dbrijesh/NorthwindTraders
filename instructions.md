...
Northwind Traders is a demonstration project showcasing Clean Architecture principles with .NET Core. This is an archived reference implementation that demonstrates the simplest approach to Clean Architecture patterns.

**Status**: Archived - No longer actively maintained

## Purpose

- Educational reference for Clean Architecture implementation
- Demonstrates separation of concerns across architectural layers
- Shows integration between .NET Core backend and Angular frontend
- Provides examples of CQRS, MediatR, and Entity Framework patterns
...
- API documentation with NSwag/OpenAPI
